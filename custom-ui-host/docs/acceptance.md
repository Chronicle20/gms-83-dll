...
| 10.4.c reserved/denylist/already-bound vk rejected | `custom-ui-host: BindHotkey rejected -- vk=0x` (covers denylist, funckey-conflict, and already-bound rejections) |
| 10.4.d out-of-range register | `custom-ui-host: RegisterPacketHandler rejected -- opcode` |
