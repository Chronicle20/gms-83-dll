...
static_assert(sizeof(CtrlButtonCreateParam) == 16,
              "CCtrlButton::CREATEPARAM must be 16 bytes (UOL at offset 12)");

// Default button image: a universally-present GMS node with
// normal/mouseOver/pressed/disabled frames.
const unsigned short *const kDefaultButtonUOL =
    reinterpret_cast<const unsigned short *>(L"UI/Basic.img/BtOK");
...
CustomUI_AddButton(CustomUI_WindowHandle h, int x, int y, int /*w*/, int /*h_*/,
    ...
    reinterpret_cast<void(__fastcall *)(void *, void *)>(C_CTRL_BUTTON_CTOR)(
        buf, nullptr);
    ...
    custom_ui_host::CtrlId id = fe.next_ctrl_id++;
    reinterpret_cast<void(__fastcall *)(void *, void *, void *, unsigned int,
                                        long, long, long, void *)>(
        C_CTRL_BUTTON_CREATE_CTRL)(buf, nullptr, wnd->GameWnd(), id, x, y, 0,
                                   &param);
    ...
    entry.raw = buf;
    entry.on_click = reinterpret_cast<void(__cdecl *)(
        custom_ui_host::WindowHandle, custom_ui_host::CtrlId, void *)>(onClick);
    entry.user = nullptr;
    entry.text = text ? text : "";
    entry.draw_x = x;
    entry.draw_y = y;
...
CustomUI_AddEdit(CustomUI_WindowHandle h, int x, int y, int w, int h_,
    ...
    reinterpret_cast<void(__fastcall *)(void *, void *)>(C_CTRL_EDIT_CTOR)(
        buf, nullptr);
    ...
    reinterpret_cast<void(__fastcall *)(void *, void *)>(
        C_CTRL_EDIT_CREATEPARAM_CTOR)(cp, nullptr);
    ...
    reinterpret_cast<void(__fastcall *)(void *, void *, void *, unsigned int,
        ...
        C_CTRL_WND_CREATE_CTRL)(buf, nullptr, wnd->GameWnd(), id, x, y, w, h_,
                                cp);

    // 4. Optional initial text (ANSI).
    if (initialText) {
        reinterpret_cast<void(__fastcall *)(void *, void *, const char *)>(
            C_CTRL_EDIT_SET_TEXT)(buf, nullptr, initialText);
    }

    // CREATEPARAM dtor (releases its embedded ZXString members).
    reinterpret_cast<void(__fastcall *)(void *, void *)>(
        C_CTRL_EDIT_CREATEPARAM_DTOR)(cp, nullptr);
...
CustomUI_GetEditText(CustomUI_WindowHandle h, CustomUI_CtrlId c, char *buf,
    ...
    reinterpret_cast<ZXString<char> *(__fastcall *)(void *, void *,
                                                    ZXString<char> *)>(
        C_CTRL_EDIT_GET_TEXT)(edit, nullptr, &out);
