...
typedef void(__cdecl* CustomUI_OnClickFn)(CustomUI_WindowHandle w, CustomUI_CtrlId c, void* user);

typedef void(__cdecl* CustomUI_PacketHandlerFn)(unsigned short opcode, const unsigned char* payload,
                                                unsigned int payloadLen, void* user);
...
__declspec(dllexport) CustomUI_CtrlId __cdecl CustomUI_AddLabel(CustomUI_WindowHandle h, int x, int y,
                                                                const char* text);
__declspec(dllexport) CustomUI_CtrlId __cdecl CustomUI_AddButton(CustomUI_WindowHandle h, int x, int y, int w, int h_,
