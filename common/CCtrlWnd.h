...
class CCtrlWnd : IGObj, IUIMsgHandler, ZRefCounted {
    ...
    // v79/v72: the 3 trailing flags are 4-byte in the binary. CCtrlWnd::CCtrlWnd
    // (v79 @0x4d4378, v72 @0x4cc645 — byte-identical) writes
    ...
    // class (CCtrlButton, CCtrlCheckBox). task-008 (v79); task-009 (v72).
...
#if (defined(REGION_GMS) && (BUILD_MAJOR_VERSION == 72 || BUILD_MAJOR_VERSION == 79))
assert_size(sizeof(CCtrlWnd), 0x34); // ctor v79 @0x4d4378 (task-008), v72 @0x4cc645 (task-009)
#endif